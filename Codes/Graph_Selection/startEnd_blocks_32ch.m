...
function response_graphs = response_locked(EEG)
    ...
    for i = 1:size(EEG.Windows_lowGamma.number_Window_Trial_backward,1)
        if EEG.isFixedDuration(EEG.Windows_lowGamma.backwindowTrials(i)) ~= 1 && EEG.Windows_lowGamma.number_Window_Trial_backward(i) <= num_window
            ...
            resLockedGraph_beta(EEG.Windows_lowGamma.number_Window_Trial_backward(i),:,:) = resLockedGraph_beta(EEG.Windows_lowGamma.number_Window_Trial_backward(i),:,:) + EEG.Windows_beta.backwardGraphs(i,:,:);
            resLockedGraph_lowGamma(EEG.Windows_lowGamma.number_Window_Trial_backward(i),:,:) = resLockedGraph_lowGamma(EEG.Windows_lowGamma.number_Window_Trial_backward(i),:,:) + EEG.Windows_lowGamma.backwardGraphs(i,:,:);
...
function firstBlob_graphs = firstBlob_locked(EEG)
    ...
    for i = 1:size(EEG.Windows_lowGamma.number_Window_Trial_forward,1)
        if EEG.isFixedDuration(EEG.Windows_lowGamma.forwindowTrials(i)) ~= 1 && EEG.Windows_lowGamma.number_Window_Trial_forward(i) <= num_window && EEG.Windows_lowGamma.number_Window_Trial_forward(i) > 1 
            ...
            blobLockedGraph_beta(EEG.Windows_lowGamma.number_Window_Trial_forward(i)-1,:,:) = blobLockedGraph_beta(EEG.Windows_lowGamma.number_Window_Trial_forward(i)-1,:,:) + EEG.Windows_beta.forwardGraphs(i,:,:);
