...
for i = 1:60
    if i < 13 || i > 16
        [Graphs_lowConf(i),Graphs_highConf(i)] = start_end(i);
    end
end

save('Graphs_lowConf_blocks.mat','Graphs_lowConf');
save('Graphs_highConf_blocks.mat','Graphs_highConf');

function [Graphs_lowConf,Graphs_highConf] = start_end(subject)
